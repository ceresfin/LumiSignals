# Penny Levels Reference Table (Non-JPY)

## Complete List of Penny Levels (0.0000 to 3.0000)

This is a static reference table of all penny levels for non-JPY pairs. The pattern repeats every 10 levels: 000, 100, 200, 300, 400, 500, 600, 700, 800, 900 (every 100 pips)
...
**Penny Level Endings (Non-JPY):**
- .0000, .0100, .0200, .0300, .0400, .0500, .0600, .0700, .0800, .0900 (every 100 pips)
- Pattern repeats every 1000 pips (0.1000)

**Relationship to Other Levels:**
- **Regular Quarters**: .0000, .0250, .0500, .0750 (every 250 pips) - Some overlap
- **Small Quarters**: .0000, .0025, .0050, .0075 (every 25 pips) - Some overlap
- **Pennies**: .0000, .0100, .0200, .0300 (every 100 pips) - Unique granularity

**Level Hierarchy:**
1. **Pennies**: Every 100 pips (10 levels per 1000 pips)
2. **Small Quarters**: Every 25 pips (40 levels per 1000 pips)
3. **Regular Quarters**: Every 250 pips (4 levels per 1000 pips)

**Usage Notes:**
- Penny levels provide intermediate granularity between small quarters and regular quarters
- Useful for momentum-based trading and multi-timeframe analysis
- Pattern is always last three digits: 000, 100, 200, 300, 400, 500, 600, 700, 800, 900
- Total levels: 300 levels from 0.0000 to 3.0000
- Particularly effective with multi-timeframe momentum analysis
