...
def get_timeframe_fibonacci_ratios(timeframe: str) -> dict:
    ...
    timeframe_ratios = {
        'D1': {
            'retracement': [0.0, 0.236, 0.382, 0.5, 0.618, 0.786, 0.886, 1.0],
            'extension': [0.0, 0.618, 1.0, 1.272, 1.382, 1.414, 1.618, 2.0, 2.618]
        },
        'H4': {
            'retracement': [0.0, 0.236, 0.382, 0.5, 0.618, 0.786, 0.886, 1.0],
            'extension': [0.0, 0.618, 1.0, 1.272, 1.382, 1.618, 2.0]
        },
        'H1': {
            'retracement': [0.0, 0.236, 0.382, 0.5, 0.618, 0.786, 0.886, 1.0],
            'extension': [0.0, 0.618, 1.0, 1.272, 1.382, 1.618]
        },
        'M30': {
            'retracement': [0.0, 0.382, 0.5, 0.618, 0.786, 0.886, 1.0],
            'extension': [0.0, 1.0, 1.272, 1.382, 1.618]
        },
        'M15': {
            'retracement': [0.0, 0.382, 0.5, 0.618, 0.786, 0.886, 1.0],
            'extension': [0.0, 1.0, 1.272, 1.382, 1.618]
