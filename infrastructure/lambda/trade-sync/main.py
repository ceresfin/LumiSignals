...
try:
    ...
    from sync.cancelled_orders import sync_cancelled_orders_enhanced
...
def run_sync(oanda_creds, airtable_creds):
    ...
    # 4. Sync Cancelled Orders (placeholder)
    logger.info("4️⃣ Syncing Cancelled Orders...")
    results['cancelled_orders'] = sync_cancelled_orders_enhanced(
        oanda_data['orders'],
        airtable_headers,
        base_id
    )
    
    # 5. Sync Currency Pair Positions
    logger.info("5️⃣ Syncing Currency Pair Positions...")
    ...
    # 6. Sync Closed Trades (ALL from June 2025)
    logger.info("6️⃣ Syncing Closed Trades...")
