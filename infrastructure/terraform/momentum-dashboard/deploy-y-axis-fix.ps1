...
Write-Host ""
Write-Host "Monitor CloudFront invalidation:" -ForegroundColor Gray
Write-Host "aws cloudfront get-invalidation --distribution-id $CLOUDFRONT_DISTRIBUTION --id $INVALIDATION_OUTPUT" -ForegroundColor Gray