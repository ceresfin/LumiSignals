...
def verify_vs_tv(session, key, tickers, years, workers, market="stocks"):
    ...
    url = ("" + os.environ.get("COMPARE_API_BASE", "https://your-domain.example") + "/api/mobile/compare/levels?tickers="
           + ",".join(tickers))
